var translation_en={
  ...
  distance_peer:{
    ...
    invited_instruction: 'Enter the email of student' ,
    ...
    in_distance_peer: 'You are in a distance peer session with student ',
    the_another_student_finished_status: 'The another student finished this part, you can play the video',
    waiting_the_another_student_to_finish: 'Waiting the another student to finish this part',
    click_on_button_below_to_end_session: "Click on button below to end distance peer session",
    you_can_not_seek_to_time_after_quiz: "You can not seek to time after quiz",
  },
  editor:{
