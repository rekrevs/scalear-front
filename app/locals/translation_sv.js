var translation_sv={
  ...
  distance_peer:{
    ...
    invited_instruction: 'Enter the email of student(t)' ,
    ...
    video_stage: 'Video(t)',
    intro_stage: '@:inclass.intro_stage',
    self_stage: '@:inclass.self_stage',
    multiple_choice: '@:inclass.multiple_choice',
    group_stage: '@:inclass.group_stage',
    multiple_choice: '@:inclass.multiple_choice',
    end_video_stage: 'End(t)',
    end_session: "End Distance Peer Session(t)",
    in_distance_peer: 'You are in a distance peer session with student (t)',
    the_another_student_finished_status: 'The another student finished this part, you can play the video(t)',
    waiting_the_another_student_to_finish: 'waiting_the_another_student_to_finish(t)',
  },
  editor:{
