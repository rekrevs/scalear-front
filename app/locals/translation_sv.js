var translation_sv={
  ...
  privacy:{
    ...
    gdpr_compliance_details_8:"Du kan ladda ner en portabel elektronisk kopia av dina data från sidan Kontoinformation.",
    gdpr_compliance_details_9:"Rätt till dataportabilitet. För en portabel elektronisk version av dina data, vänligen fyll i en supportförfrågan med hjälp av hjälpmenyn.",
    gdpr_compliance_details_10:"Förstöring av data. Data behålls i enlighet med 'Lagring av uppgifter och radering av din profil' ovan. Vi upprätthåller en envägshashad lista över konton för att kunna identifiera avslutad behandling.",
    gdpr_compliance_details_11:"Rätt till objekt. Ta bort ditt konto för att begränsa behandling av data från tredje part. Observera att data som lämnats till tredje part kan ha anonymiserats på ett sådant sätt att det inte går att ta bort specifika användares data från sådana samlingar.",
    gdpr_compliance_details_12:"Incidentrapportering. I händelse av dataläckage kommer alla potentiellt drabbade användare att bli underrättade inom 72 timmar efter detektering.",
    gdpr_compliance_details_13:"Användningsbegränsningar. Datainsamling och behandling är begränsad till syftet att hjälpa studenter och lärare, och att utveckla nya undervisningstekniker och förbättra systemet.",
    gdpr_compliance_details_14:"Rätt till åtkomst. Information om syftet med datainsamling, typer av insamlade data, vad som anges, hur länge data behålls och varifrån data kommer ifrån beskrivs ovan och i konsekvensanalysen.",
