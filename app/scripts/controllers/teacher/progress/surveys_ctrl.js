...
angular.module('scalearAngularApp')
    .controller('surveysCtrl', ['$scope', '$stateParams', '$timeout', 'Module', 'Quiz', '$translate', '$log',
        function($scope, $stateParams, $timeout, Module, Quiz, $translate, $log) {
            ...
            $scope.getSurveyCharts = function(view, module_id, survey_id) {
                ...
                Module.getSurveyCharts({
                    ...
                    function(data) {
                        $log.debug(data)
                        console.log(data.chart_questions);
            ...
            $scope.formatSurveyChartData = function(data) {
                ...
                formated_data.cols =
                    ...
                    "label": $translate('controller_msg.answered'),
                    "type": "number"
                }, ]
                formated_data.rows = []
                for (var ind in data) {
