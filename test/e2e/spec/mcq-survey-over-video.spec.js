...
describe("1", function(){
	...
	it('should add a module and lecture to create surveys', function(){
		...
		teacher.create_lecture(ptor, "mcq_survey_quiz","https://www.youtube.com/watch?v=SKqBmAHwSkg", o_c.feedback);
	})

	it('should create quiz', function(){
		youtube.seek(ptor, 49);
		create_mcq_survey(ptor, o_c.feedback);
        make_mcq_questions_and_check(ptor, mcq_s_q1_x, mcq_s_q1_y, mcq_s_q2_x, mcq_s_q2_y, mcq_s_q3_x, mcq_s_q3_y, o_c.feedback);
	})
...
describe("2", function(){
	...
	it('should create quiz', function(){
		youtube.seek(ptor, 49);
		create_mcq_survey(ptor, o_c.feedback);
		make_mcq_survey_questions(ptor, mcq_s_q1_x, mcq_s_q1_y, mcq_s_q2_x, mcq_s_q2_y, mcq_s_q3_x, mcq_s_q3_y, o_c.feedback);
	})
...
function create_mcq_survey(ptor, feedback){
...
function make_mcq_survey_questions(ptor, q1_x, q1_y, q2_x, q2_y, q3_x, q3_y, feedback){
