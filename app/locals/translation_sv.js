var translation_sv={
  ...
  feedback:{
    like_to_comment: "What's your question, comment, or issue?(t)",
    what_you_think: "What do you need help with?(t)",
    instructions:"This helps us make sure you get the right answer as fast as possible.(t)",
    ...
    leave_feedback:"Share all the details. The more we known, the better we can help you.(t)",
  ...
  inclass:{
    ...
    total_inclass_time: "Total In-Class Time (t)",
    peer_problem_time:"Peer Problem Time (t)",
    review_time:"Review Time (t)",
    ...
    change_defaults: "change defaults (t)",
    intro_stage:"Intro (t)",
    self_stage:"Self (t)",
    group_stage:"Group (t)",
    discussion_stage:"Discussion (t)",
    session_not_started:"The in-class session has not started (t)",
    please_try_or_refresh:"Please try again later or click on the 'Refresh' button below (t)",
    question_not_started:"The in-class question has not started (t)",
    click_next_question: "Click on 'Next' when the question shows up (t)",
  },
  editor:{
    ...
    end_time: "Slut-tid",
    intro_timer:"Intro Timer (t)",
    self_timer:"Self Timer (t)",
    group_timer:"Group Timer (t)",
    discussion_timer:"Discussion Timer (t)",
    preview_inclass: "Preview in-class (t)",
