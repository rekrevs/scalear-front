...
describe("Sign up Teacher 1",function(){
	describe("guerrillamail",function(){
		it("should sign up as teacher",function(){
			...
			signup_page.create(params.teacher_mail, params.guerrillamail_password , params.guerrillamail_sch_uni_name , params.guerrillamail_last_name , params.guerrillamail_first_name )
		})
...
describe("Sign up Student 1",function(){
	describe("guerrillamail",function(){
		it("should sign up as student",function(){
			...
			signup_page.create(params.teacher2_mail, params.guerrillamail_password , params.guerrillamail_sch_uni_name , params.guerrillamail_last_name , params.guerrillamail_first_name )
		})
		it("should check url thanks pages",function(){
			sleep(6000)
			expect(browser.driver.getCurrentUrl()).toContain('thanks')
...
describe("Sign up Student 1",function(){
	describe("guerrillamail",function(){
		it("should sign up as student",function(){
			...
			sleep(4000)
			signup_page.sign_up('student')
			signup_page.create(params.student_mail, params.guerrillamail_password , params.guerrillamail_sch_uni_name , params.guerrillamail_last_name , params.guerrillamail_first_name )
		})
		it("should check url thanks pages",function(){
			sleep(6000)
			expect(browser.driver.getCurrentUrl()).toContain('thanks')
...
describe("Sign up Student 2",function(){
	describe("guerrillamail",function(){
		it("should sign up as student",function(){
			...
			sleep(4000)
			signup_page.sign_up('student')
			signup_page.create(params.student2_mail, params.guerrillamail_password , params.guerrillamail_sch_uni_name , params.guerrillamail_last_name , params.guerrillamail_first_name )
		})
		it("should check url thanks pages",function(){
			sleep(6000)
			expect(browser.driver.getCurrentUrl()).toContain('thanks')
...
describe("Sign up Student 3",function(){
	describe("guerrillamail",function(){
		it("should sign up as student",function(){
			...
			sleep(4000)
			signup_page.sign_up('student')
			signup_page.create(params.student3_mail, params.guerrillamail_password , params.guerrillamail_sch_uni_name , params.guerrillamail_last_name , params.guerrillamail_first_name )
		})
		it("should check url thanks pages",function(){
			sleep(6000)
			expect(browser.driver.getCurrentUrl()).toContain('thanks')
