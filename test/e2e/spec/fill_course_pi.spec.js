...
describe("Filling Course", function() {
  describe("Teacher", function() {
    ...
    it("should go to the correct quiz time", function() {
      ...
      expect(video.current_time).toContain(quiz_time_string)
      expect(invideo_quiz.time).toContain("0" + quiz_time_string)
      expect(invideo_quiz.intro_time).toContain("00:02:00")
      expect(invideo_quiz.self_time).toContain("00:02:00")
      expect(invideo_quiz.group_time).toContain("00:02:00")
      expect(invideo_quiz.discussion_time).toContain("00:02:00")
    })
    ...
    var offset = 4.9
    var quiz_time_string = utils.percent_to_time_string(video_percent, total_duration)
    var start_time_string = '0:00:14'//utils.percent_to_time_string(video_percent - offset, total_duration)
    ...
    it("should go through the preview inclass stages", function() {
      expect(video.current_time).toContain(start_time_string)
      ...
      expect(video.current_time).toContain(quiz_time_string)
      course_editor.inclass_next()
      expect(video.current_time).toContain(end_time_string)
      course_editor.inclass_next()
      expect(video.current_time).toContain(end_time_string)
    })
