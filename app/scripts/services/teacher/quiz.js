...
.factory('Quiz', ['$resource','$http','$stateParams','scalear_api','headers','$rootScope',function($resource, $http, $stateParams, scalear_api, headers, $rootScope) {

    $http.defaults.useXDomain = true;
    return $resource(scalear_api.host+'/'+$rootScope.current_lang+'/courses/:course_id/quizzes/:quiz_id/:action', {course_id:$stateParams.course_id},
