var translation_sv=function(){
    return {
      ...
      enroll:{
        ...
        this_term_new_system:"Denna term vi kommer att använda ett online-system för att göra din inlärning mer interaktiv. För att använda det här systemet måste du skapa ett konto och lägga till den här kursen. För att göra detta, vänligen besök: ttp://www.scalable-learning.com/#/users/student och skapa ett studentkonto med ditt universitet e-postadress. Du kan sedan lägga till kursen genom att klicka på 'Ansluta Kurs' under 'Kurser' och ange kursen kursnyckel",
