...
function MCQVideoTest(mode, ptor){
    var modeName = 'Normal';
    if(mode == 1){
        modeName = 'Full Screen';
        it('should go to fullscreen mode', function(){
            //click on Edit in full screen mode
        });
    }
    ...
    it('should display the layer on top of the video - MCQ Video', function(){
        ptor.findElement(protractor.By.className('ontop')).then(function(container){
            container.isDisplayed().then(function(disp){
                expect(disp).toBe(true);
            });
    ...
    it('should add quiz answers on top of the video - MCQ Video', function(){
        ...
        //make sure that all three checkboxes are showing
        //click each one of them and see if the popover will show
        //input answer and explanation and check the first one to be correct
    });
    it('should save quiz data - MCQ Video', function(){
    ...
    it('should check if the data is the same after refresh', function(){
        //check the answers
    });
    it('should delete one of the answers - MCQ Video', function(){
        //click on an answer
        //in the popover section click on remove
    });
    it('should save quiz data after deletion - MCQ Video', function(){
        //click on save button
    });
    it('should refresh the page', function(){
        //refresh page
    ...
    it('should check if the data is the same after deletion', function(){
        //check the answers
    });
    it('should delete the quiz', function(){
        //delete the quiz
        //make sure there isn't any quiz displayed
    });
    if(mode == 1){
        modeName = 'Full Screen';
        it('should exit fullscreen mode', function(){
