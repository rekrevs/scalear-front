...
InvideoQuiz.prototype = Object.create({}, {
	...
	intro_time_field:{get:function(){return element(by.model("selected_quiz.intro_formatedTime"))}},
	self_time_field:{get:function(){return element(by.model("selected_quiz.self_formatedTime"))}},
	group_time_field:{get:function(){return element(by.model("selected_quiz.group_formatedTime"))}},
	discussion_time_field:{get:function(){return element(by.model("selected_quiz.discussion_formatedTime"))}},
