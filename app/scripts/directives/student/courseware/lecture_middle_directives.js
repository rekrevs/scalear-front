...
.directive('notesTimeline',['$log','Lecture','$state', function($log,Lecture,$state){
  return{
    ...
    function($timeout) {
        return {
            template: '<div onshow="moveCursorToEnd()" ng-mouseover="overclass = true" ng-mouseleave="overclass= false"  e-rows="3" e-cols="50" blur="submit" editable-textarea="value" e-form="myform" buttons="no" onaftersave="saveData()" e-placeholder="Note..." ng-click="show()" e-style="font-size: 13px;color: teal;">'+
