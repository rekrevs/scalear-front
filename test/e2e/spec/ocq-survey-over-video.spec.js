...
xdescribe("1", function(){
	...
	it('should create quiz', function(){
        ...
        make_ocq_survey_questions_and_check(ptor, ocq_s_q1_x, ocq_s_q1_y, ocq_s_q2_x, ocq_s_q2_y, ocq_s_q3_x, ocq_s_q3_y);
	})
...
function create_ocq_survey(ptor, feedback){
	...
	locator.by_id(ptor, "ocq_sur").then(function(link){
...
function make_ocq_survey_questions(ptor, q1_x, q1_y, q2_x, q2_y, q3_x, q3_y){
...
function make_ocq_survey_questions_and_check(ptor, q1_x, q1_y, q2_x, q2_y, q3_x, q3_y, feedback){
    var ontop_w = 0;
    var ontop_h = 0;
    locator.by_id(ptor,'ontop').then(function(ontop){
