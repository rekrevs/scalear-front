...
angular.module('scalearAngularApp')
    .controller('lectureMiddleCtrl', ['$state', '$stateParams', '$scope', '$http', 'Lecture', 'lecture','CourseEditor' ,function ($state, $stateParams, $scope, $http, Lecture, lecture, CourseEditor) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	var update_answers=function(ans){
		...
		Lecture.update_answers(
			...
			{answer: ans, quiz_title:$scope.selectedQuiz.question },
			function(data){ //success
				console.log(data)
			},
			function(){
