var translation_en={
  ...
  privacy:{
    ...
    gdpr_compliance_details_8:"Right to Data Portability. You can download a portable electronic copy of your data from the Account Information page",
    gdpr_compliance_details_9:"Right to Data Portability. For a portable electronic version of your data, please file a support request using the help menu.",
    gdpr_compliance_details_10:"Destruction of Data. Data is retained in according “Data retention and Deleting your Profile” above. We maintain a hashed list of accounts to be able to identify completed processing activities.",
    gdpr_compliance_details_11:"Right to Object. To limit third-party processing of your data, please delete your account. Note that data provided to third parties may be anonymized such that it is not possible to remove particular users’ data from such collections.",
    gdpr_compliance_details_12:"Incident Reporting. In the event of a data leak, all potentially affected users will be notified within 72 hours of detection of the data leak.",
    gdpr_compliance_details_13:"Usage Limitations. Data collection and processing is limited to the purposes of helping students and teachers learn, and to develop new teaching techniques and improving the system.",
    gdpr_compliance_details_14:"Right to Access. Information on the purpose for data collections, types of data collected, what is given out, how long data is retained, and where data comes from are described above and in the Impact Assessment.",
    ...
    acceptable_use_policy_details_12:"The managers of the ScalableLearning service are entitled to inspect material on the service and remove inappropriate content",
    acceptable_use_policy_details_13:"You are liable for the consequences of any violations by you of the Acceptable Use Policy.",
    other:"Other",
