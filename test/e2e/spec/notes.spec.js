...
describe("Notes",function(){
	describe("Student",function(){
		...
		it("should edit note",function(){
			student_lec.lecture(1).edit_note(1)

			student_lec.lecture(1).type_note("Editied note for testing.")
			expect(student_lec.lecture(1).notes.count()).toEqual(1)
			expect(student_lec.lecture(1).note(1).getText()).toEqual("Editied note for testing.")
		})
		...
		it("should add an empty note",function(){
			student_lec.add_note()
			student_lec.lecture(1).type_note("")
			expect(student_lec.lecture(1).notes.count()).toEqual(0)
