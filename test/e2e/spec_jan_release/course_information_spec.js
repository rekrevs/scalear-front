...
function login(ptor, driver, email, password, name, findByName) {
    it('should login', function() {
        ptor.get(ptor.params.frontend + 'users/login').then(function(){
            ptor.sleep(10000);
        });
        ptor.findElements(protractor.By.id('user_email')).then(function(email_fields) {
            email_fields[1].sendKeys(email);
        });
...
describe("Course Information Pages", function() {
    ...
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             console.log(today)
    //             expect(data[3].getText()).toBe(today);
    //         });
    //     });
    //     it('should display course duration', function() {
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             expect(data[4].getText()).toBe('5 Weeks');
    //         });
    //     });
    //     it('should display course discussion forum link', function() {
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             expect(data[5].getText()).toBe('http://google.com/ | Visit Link');
    //         });
    //     });
    //     it('should display course Description', function() {
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             expect(data[6].getText()).toBe('new description');
    //         });
    //     });
    //     it('should display course prerequisites', function() {
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             expect(data[7].getText()).toBe('new prerequisites');
    //         });
    //     });
    //     it('should display course time zone', function() {
    //         ptor.findElements(protractor.By.tagName('p')).then(function(data) {
    //             expect(data[8].getText()).toBe('Abu Dhabi');
    //         });
    //     });
    ...
    //         ptor.findElements(protractor.By.tagName('details-text')).then(function(duration_fields) {
    //             duration_fields[2].click();
    //             ptor.findElement(protractor.By.className('editable-input')).then(function(field) {
    //                 field.clear();
    //                 field.sendKeys('10');
    //             });
    //             ptor.findElement(protractor.By.className('icon-remove')).click();
    //             expect(duration_fields[2].getText()).toBe('5');
    //             duration_fields[2].click();
    //             ptor.findElement(protractor.By.className('editable-input')).then(function(field) {
    //                 field.clear();
    //                 field.sendKeys('any text');
    //             });
    //             ptor.findElement(protractor.By.className('icon-ok')).click();
    //             expect(duration_fields[2].getText()).toBe('Duration is not a number');
    //             duration_fields[2].click();
    //             ptor.findElement(protractor.By.className('editable-input')).then(function(field) {
    //                 field.clear();
    //                 field.sendKeys('-10');
    //             });
    //             ptor.findElement(protractor.By.className('icon-ok')).click();
    //             expect(duration_fields[2].getText()).toBe('Duration must be greater than 0');
    //             duration_fields[2].click();
    //             ptor.findElement(protractor.By.className('editable-input')).then(function(field) {
    //                 field.clear();
    //                 field.sendKeys('10');
    ...
    //             ptor.findElement(protractor.By.className('icon-ok')).click();
    //             feedback(ptor, 'Course was successfully updated.');
    //             expect(duration_fields[2].getText()).toBe('10');
    //         });
    //     });
    ...
    //             });
    //             ptor.findElement(protractor.By.className('icon-remove')).click();
    //             expect(fields[3].getText()).toBe('http://google.com/');
    //             fields[3].click();
    //             ptor.findElement(protractor.By.className('editable-input')).then(function(field) {
    //                 field.clear();
    //                 field.sendKeys(' ');
    //             });
    //             ptor.findElement(protractor.By.className('icon-ok')).click();
    //             expect(fields[3].getText()).toBe('Empty');
    ...
    //             ptor.findElement(protractor.By.className('icon-ok')).click();
    //             feedback(ptor, 'Course was successfully updated.');
    //             expect(fields[3].getText()).toBe('http://www.google.com');
    //         });
    //     });
