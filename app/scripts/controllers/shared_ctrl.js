...
angular.module('scalearAngularApp')
  .controller('sharedCtrl',['$scope','Page','SharedItem','Module', function ($scope,Page,SharedItem,Module) {
  	...
  	$scope.addModule=function(shared_item_index, module_index,course){
  		Module.moduleCopy(
		{course_id: course.id},
		...
		function(data){
			...
			shared_copy.modules.splice(module_index,1)
