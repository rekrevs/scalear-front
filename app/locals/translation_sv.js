var translation_sv={
  ...
  privacy:{
    ...
    acceptable_use_policy_details_7:"Du ska skydda ditt konto och alla känsliga data och filer som den ger tillgång till.",
    acceptable_use_policy_details_8:"Du ska omedelbart rapportera varje känt eller misstänkt säkerhetsintrång eller missbruk av din registrering, eller den information till vilken den ger tillgång till ScalableLearnings dataskyddskontakt (se ovan) och/eller till Tjänsteleverantören (se nedan).",
    acceptable_use_policy_details_9:"All användning av ScalableLearning-tjänsten sker på egen risk. Det finns ingen garanti för att tjänsten kommer att finnas tillgänglig när som helst eller att den passar för alla ändamål.",
    acceptable_use_policy_details_10:"Ledningen för ScalableLearning-tjänsten har rätt att begränsa och avsluta tillgången till tjänsten och du ska genast följa deras instruktioner, med förbehåll för separata avtal.",
    acceptable_use_policy_details_11:"Du är ansvarig för följderna av eventuella överträdelser.",
    other:"Andra",
    legal_entity: "Juridisk enhet / Tjänsteleverantör",
    legal_entity_details: "ScalableLearning tillhandahålls av RISE SICS AB, Box 1263, SE-164 29 Kista.",
