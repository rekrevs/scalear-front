var translation_sv=function(){
  return {
    ...
    name: "Namn",
    email: "E-post",
    edit_email:"E-post (på skolan eller universitetet)",
    password: "Lösenord",
    ...
    navigation:{
      ...
      logout: "Utloggning",
      login: "Inloggning",
      edit_account: "Konto-information",
      courses: "Mina Kurser",
    ...
    enroll:{
      ...
      add_course_by_choosing: "Lägg din kurs genom att välja 'Gå Kurser' från menyn 'Kurser' och ange kursnyckeln för",
    ...
    notification:{
      ...
      reviewed_inclass: "Vill du att läraren skall gå igenom denna fråga i klassen"
    },
    privacy:{
    ...
    lectures:{
      ...
      details: "Detaljer",
      timeline: "Tidslinje",
      lecture_details: "Föreläsningsdetaljer",
      ...
      detected_aspect_ratio: "Detektera bildformat",
      title: "Titel",
      ...
      server: "Servern",
      is_slow: " tar lång tid för att läsa in den här videon",
      ...
      click_or_type_note: "Klicka eller typ N för att lägga till en anteckning",
      click_or_type_question: "Klicka eller typ Q för att ställa en fråga",
      click_or_type_confused: "Klicka eller typ C säga förvirrad",
      click_or_type_fullscreen: "Klicka eller typ F för att gå in i helskärmsläge",
      click_or_type_smallscreen: "Klicka eller typ F för att gå in liten skärm",
      finish_before_proceeding:"Avsluta tidigare obligatoriska föreläsningar innan du fortsätter",
    ...
    courses:{
      ...
      select_lecture: "Välj en föreläsning",
      ...
      progress_graph: "Framsteg Graph",
      progress_graph_desc: "Videos och quizzar slutförande procentsatser för alla studenter",
      course_progress: "Kurs Framsteg",
      lecture_progress: "Föreläsning Framsteg",
      quizzes_progress: "Quizzar Framsteg",
      ...
      quizzes_for_review: "Quizzar för översyn",
    ...
    controller_msg:{
      ...
      update_account_information: "Vänligen uppdatera din Konto-information för att använda den nya versionen av ScalableLearning."
    },
    statistics:{
    ...
    news:
    {
      new_lecture: "Ny föreläsning tillagd ",
    ...
    content:{
      ...
      types:{
        ...
        quiz_or_survey_desc: "Text-baserad, kan vara obligatorisk eller valfri",
      },
      questions:{
