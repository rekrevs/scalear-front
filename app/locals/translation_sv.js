var translation_sv={
  ...
  account:{
    ...
    sign_in: "Logga in",
    can_not_use_domain: "Du kan inte registrera sig med den här domänen. För att skapa ett konto, logga in via din skola leverantör.",
    ...
    back: "@:global.back",
    go_to_support:"Om du behöver hjälp, bara att gå till stöd för Hjälp-menyn",
    account_confirmed: "Ditt konto {{email}} har konfirmerats.",
    start_using: "att börja använda",
    invalid_confirmation: "Denna bekräftelse länken är inte längre giltigt. (Det har antingen gått ut eller redan har använts.)",
  ...
  dashboard:{
    ...
    you_solved_group_survey: "Du löst grupp enkät.",
    you_not_answered_quiz: "Du svarade inte det detta frågesport.",
    answered_survey: " besvarade denna enkä",
    answered: ' svarade',
    ...
    not_checked_group: " inte har kontrollerats av läraren.",
    ...
    click_retry_quiz: "Klicka för att försöka igen det här frågesport.",
    less_one_hour: "färdigdatum mindre än en timme.",
    correct: "korrekt",
    incorrect: "felaktig",
    answer: "svar",
    survey: "enkät",
