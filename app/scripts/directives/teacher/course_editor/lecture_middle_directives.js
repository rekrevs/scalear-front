  ...
  .directive('answervideo', function() {
    ...
    return {
      ...
      template: "<div>" +
        ...
        "</div>" +
        "</div>" +
        "<div class='dragged handle' data-drag='true' style='max-height: 58px; overflow: scroll;border-radius: 10px; padding: 10px;' ng-style=\"{left: (data.sub_xcoor*100)+'%', top: (data.sub_ycoor*100)+'%'}\" data-jqyoui-options=\"{containment:'.ontop'}\" jqyoui-draggable=\"{animate:true, onStop:'calculatePosition'}\" >" +
