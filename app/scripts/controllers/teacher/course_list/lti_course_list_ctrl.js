...
angular.module('scalearAngularApp')
  .controller('ltiCourseListCtrl', ['$rootScope', '$scope', 'Lti', '$state', '$window','$location','Page','$stateParams', 'User', function($rootScope, $scope, Lti, $state, $window,$location, Page, $stateParams , User) {
    ...
    $scope.embed = function(type, type_id , event, type_name) {
        ...
        var sl_url = "http://"+location.host+"/en/lti/lti_launch_use?sl_type_id="+type_id+"%26sl_type="+type  
